  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unleash the power of efficient management with Restaurant Booking Engine: Reserving tables, managing reservations and menus in Bulgarian, all in one place."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash the power of efficient management with Restaurant Booking Engine: Reserving tables, managing reservations and menus in Bulgarian, all in one place.`}
            </Text>
            <Box
